...
# Create directories
if not os.path.exists(os.path.join(args.root, 'lib/GL')):
    os.makedirs(os.path.join(args.root, 'lib/GL'))

# Download glcorearb.h
if not os.path.exists(os.path.join(args.root, 'lib/GL/glcorearb.h')):
    print('Downloading glcorearb.h to {0}...'.format(os.path.join(args.root, 'lib/GL/glcorearb.h')))
    web = urllib2.urlopen('http://www.opengl.org/registry/api/GL/glcorearb.h')
    with open(os.path.join(args.root, 'lib/GL/glcorearb.h'), 'wb') as f:
        f.writelines(web.readlines())
else:
    print('Reusing glcorearb.h from {0}...'.format(os.path.join(args.root, 'lib/GL')))
...
# Generate gl3w.h
print('Generating gl3w.h in {0}...'.format(os.path.join(args.root, 'lib/GL')))
...
# Generate gl3w.c
print('Generating gl3w.c in {0}...'.format(os.path.join(args.root, 'lib/GL')))
with open(os.path.join(args.root, 'lib/GL/gl3w.c'), 'wb') as f:
    write(f, UNLICENSE)
